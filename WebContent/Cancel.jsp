...
<div style="color: black; text-align: center; font-size: 30px;">Canceled Orders</div>
...
<hr>
       ...
       try
       {
    	   ...
    	   PreparedStatement ps=con.prepareStatement("select * from myorder where status='canceled'");
