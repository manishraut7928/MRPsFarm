...
.signup a:hover{
 ...
 <body>
    ...
    <div class="bg-img">
      <div class="content">
        <header style="color:#cc162f">Login Here</header>
...
String user=request.getParameter("msg");
      ...
      <header style="font-size:17px; color:white;">  Enter Valid details</header>
...
<br>
        ...
        <form action="loginaction.jsp"  method="post">
          <div class="field">
            ...
            <input type="text" name="userid"  placeholder="Email-id" required>
          </div>
