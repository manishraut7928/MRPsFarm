...
<html>
  ...
  <body>
    <div class="main-block">
      ...
      <form action="MyOrderCancelAction.jsp">
        <div class="title">
...
<option value="why my product is cancel?">why my product is cancel?"</option>
        ...
        <div class="checkbox">
          <input type="checkbox" name="checkbox"><span>I agree to the <a href="https://www.w3docs.com/privacy-policy">Privacy Policy of VastraCollection.</a></span>
        </div>
