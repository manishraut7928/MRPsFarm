...
<br>
        ...
        <center> 
         ...
         <input type="number" name="mobilenumber" placeholder="Enter Mobile Number"  pattern="\d{10}" title="Incorrect mobile no" required>
         </div>
        ...
        <div class="field">
            ...
            <input type="text" required placeholder="Email" name="email" pattern=".+@gmail\.com|.+@yahoo\.in">
          </div>
               <br>
